...
You should read jerry's blog for an in depth explanation, but the tldr is that we replace the axial rope rotations 
...
The story is still developing, as the group is trying to figure out how to extend this to higher dimensions while preserving the isotropic properties of the 2D case.