...
[Kevin Yin](https://research.novelai.net/kevin/) wrote a follow-up appendix to jerry's post, attributing most of the success to incoherent angles instead of angle uniformity. He also expands on finding the optimal angle spacing by formulating it as an energy minimization problem.[^kevins-post]
...
Play with the spacing to see how the attention scores change. Try $\pi\frac{\sqrt5-1}{2} \approx$ 1.9414[^kevins-post].
